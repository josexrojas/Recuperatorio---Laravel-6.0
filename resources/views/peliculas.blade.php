...
<a href="#" class="list-group-item list-group-item-action align-items-start">
  ...
  @if ($pelicula->genero)
      <p class="mb-1">Genero: {{$pelicula->genero->name}}</p>
  @endif

  <small class="text-muted">Rating: {{$pelicula->rating}}</small>
  <br>
  <a class="btn btn-warning" href="/editarpelicula" role="button">Editar</a>
